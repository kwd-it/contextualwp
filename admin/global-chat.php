    ...
    public function enqueue_acf_askai_script( $hook ) {
        ...
        wp_localize_script(
            ...
            [
                ...
                'contextId'  => $context_id,
                'debug'      => $debug,
                'supportedTypes' => apply_filters( 'contextualwp_acf_askai_field_types', [ 'text', 'textarea', 'wysiwyg', 'number', 'email', 'url', 'select', 'radio', 'checkbox', 'true_false', 'relationship', 'post_object', 'taxonomy', 'image', 'file', 'date_picker', 'google_map', 'group', 'repeater' ] ),
            ]
        );
    }
}
